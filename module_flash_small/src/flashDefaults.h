...
#define FLASH_PERSISTENT_SEGMENT_SIZE 32768
#endif

#ifndef FLASH_PERSISTENT_SECTOR_SIZE
#define FLASH_PERSISTENT_SECTOR_SIZE 4096
#endif

#if ((FLASH_PERSISTENT_SIZE & (FLASH_PERSISTENT_SIZE+1)) != 0)
#error "FLASH_PERSISTENT_SIZE should be a power of 2"
#endif
